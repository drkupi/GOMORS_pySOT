# -*- coding: utf-8 -*-
"""
Created on Mon Jan 28 10:49:23 2019
...
def main(x):
    ...
    for i in range(len(bsn_new_str)):
        ...
        if len(temp) > 15:
            ...
            param = temp
        print(bsn_file_copy[(bsn_linenum[i] - 1)])
    ...
    simulatedflow = np.asarray(simulatedflow)
    np.savetxt('res_simulation.txt', simulatedflow)
